...
/**
 * Strategy for Prop Hunt gamemode. Requires players to select team, class, and vote for a map
 * before readying up.
 */
public class PropHuntStrategy implements HuntGameModeStrategy {
  ...
  public ReadyResult canPlayerReady(
    ...
    // Check if player has selected team and class
  ...
  public int getMinimumPlayers() {
    return 2; // Minimum for Prop Hunt
  }
